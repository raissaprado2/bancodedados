...
--1 Exibir duplicatas em carteira do cliente PCTEC - MICROCOMPUTADORES S/A. Na listagem devem constar o nome do cliente, número da duplicata e o valor correspondente.
SELECT c.NOME AS NomeCliente, v.DUPLIC AS NumeroDuplicata, v.VALOR AS ValorDuplicata
FROM cliente c
...
--2
SELECT c.NOME AS NomeCliente, v.DUPLIC AS NumeroDuplicata, v.VALOR AS ValorDuplicata,
       (v.VALOR * 0.10) AS Juros, (v.VALOR * 1.10) AS ValorTotal
FROM cliente c
INNER JOIN venda v ON c.CODCLI = v.CODCLI
...
--3
SELECT c.NOME AS NomeCliente, v.DUPLIC AS NumeroDuplicata, v.VALOR AS ValorDuplicata, v.VENCTO AS DataVencimento
FROM cliente c
INNER JOIN venda v ON c.CODCLI = v.CODCLI
WHERE MONTH(v.VENCTO) = 10
ORDER BY c.NOME, v.VENCTO;


--4
SELECT c.NOME AS NomeCliente, COUNT(v.DUPLIC) AS QuantidadeDuplicatas, SUM(v.VALOR) AS TotalDevido
FROM cliente c
...
--6
SELECT c.NOME AS CLIENTE, COUNT(*) AS VENCIDOS
FROM cliente c
INNER JOIN venda v ON c.CODCLI = v.CODCLI
...
--7
SELECT c.NOME AS NomeCliente, v.DUPLIC AS NumeroDuplicata, v.VALOR AS ValorDuplicata, (v.VALOR * 0.10) AS Juros, (v.VALOR * 1.10) AS ValorTotal
FROM cliente c
INNER JOIN venda v ON c.CODCLI = v.CODCLI
WHERE v.VENCTO < '1999-12-31'
ORDER BY c.NOME;
