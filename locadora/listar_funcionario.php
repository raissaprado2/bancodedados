...
<div class="content read">
	...
	<table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$contact['salario']?></td>
                <td><?=$contact['data_contratacao']?></td>
                <td><?=$contact['cargo']?></td>
                <td class="actions">
	...
	<div class="pagination">
		<?php if ($page > 1): ?>
		<a href="listar_funcionario.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_contacts): ?>
		<a href="listar_funcionario.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	</div>
</div>
